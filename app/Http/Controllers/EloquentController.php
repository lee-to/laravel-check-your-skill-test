...
class EloquentController extends Controller
{
    public function task2()
    {
        ...
        // вместо []
        $products = Item::query()->where('active', true)->orderByDesc('created_at')->take(3)->get();
    ...
    public function task3()
    {
        ...
        // Одна строка кода
        // вместо []
        $products = Item::query()->active()->orderByDesc('created_at')->take(3)->get();
    ...
    public function task7(Request $request)
    {
        ...
        Item::query()->whereIn('id', reset($request->products))->delete();
